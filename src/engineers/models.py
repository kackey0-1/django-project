...
class Skill(models.Model):
    ...
    created = models.ForeignKey('accounts.CustomUser', models.DO_NOTHING, related_name='Skill_created',
                                verbose_name='作成者')
    updated_at = models.DateTimeField(null=True, verbose_name='更新日付')
    updated = models.ForeignKey('accounts.CustomUser', models.DO_NOTHING, null=True, blank=True,
                                related_name='Skill_updated', verbose_name='更新者')
    deleted_at = models.DateTimeField(null=True, verbose_name='削除日付')
    deleted = models.ForeignKey('accounts.CustomUser', models.DO_NOTHING, null=True, blank=True,
                                related_name='Skill_deleted', verbose_name='更新者')
