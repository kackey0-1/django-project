$(function() {
    $('.btn-create').click(function() {
        ...
        if (!status) {
            $('.status-radio').parent().append("<div style='color: red;' class='error'>選択してください。</div>");
        }
        ...
        if (!tel) {
            ...
            $('input[name="tel"]').parent().append("<div style='color: red;' class='error'>10〜13桁以内で入力してください。</div>");
        }
        ...
        if (!password) {
            $('input[name="password"]').parent().append("<div style='color: red;' class='error'>必須項目です。</div>");
        ...
        if (emergency_contact_name > 30) {
            $('input[name="emergency_contact_name"]').parent().append("<div style='color: red;' class='error'>30文字以内で入力してください。</div>");
        }
        ...
        if (emergency_contact_address > 150) {
            $('input[name="emergency_contact_address"]').parent().append("<div style='color: red;' class='error'>150文字以内で入力してください。</div>");
        }
