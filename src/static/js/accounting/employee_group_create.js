$(function() {  
   ...
   $('input[name="constructions"]').click(function() {
        if ($(this).prop('checked') == true) {
            ...
            $('.merchandise_order_text').css('color',"black");
        } else {
    ...
    $('.btn-create').click(function() {
        ...
        // if (!checked_count) {
        //     $('.checkbox_applications').parent().append("<div style='color: red;' class='error'>選択してください。</div>");
        // }
