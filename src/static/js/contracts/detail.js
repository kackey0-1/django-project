...
// 初期処理
$(function(){
    // 非管理者の場合管理者名の入力を許可しない。
    if($('input[name="contract_paper_type"]:checked').val() == "1"){
        $('input[name="contract_paper_type_admin_name"]').val("");
        $('input[name="contract_paper_type_admin_name"]').prop('disabled', true);
    }
...
$(function() {
    ...
    */
    ...
    /**
        非管理者、管理者を変更したとき
     */
    $('input[name="contract_paper_type"]').click(function(){
        console.log("happy");
        if($(this).val() == "1"){
            $('input[name="contract_paper_type_admin_name"]').val("");
            $('input[name="contract_paper_type_admin_name"]').prop('disabled', true);
        }else{
            $('input[name="contract_paper_type_admin_name"]').prop('disabled', false);
        }
    })
