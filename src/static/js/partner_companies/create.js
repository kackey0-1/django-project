$(function() {
    ...
    $('.btn-create').click(function() {
        ...
        var company_name_len = company_name.length;
        ...
        if (branch_name_len) {
            if (branch_name_len > 20) {
                $('input[name="branch_name"]').parent().append("<div style='color: red;' class='error'>20文字以内で入力してください。</div>");
            }
        }

        if (account_number_len) {
            if (account_number_len > 20) {
                $('input[name="account_number"]').parent().append("<div style='color: red;' class='error'>20文字以内で入力してください。</div>");
            }
        }
